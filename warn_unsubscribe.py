...
<main>
  ...
  <!-- This page lives at the site root, so "./" is the US dashboard and
       California is one level down. Both stay relative: the page is allowed
       exactly one absolute URL (the Apps Script endpoint). -->
  <p class="links">
    <a href="./">US dashboard</a> ·
    <a href="ca/">California dashboard</a>
  </p>
</main>
<script>
(function () {
  ...
  var LINKS = ' <a href="./">US dashboard</a> or ' +
              '<a href="ca/">California dashboard</a>.';
